...
void UMenu::OnCreateSession(bool bWasSuccessful)
{
	if(bWasSuccessful)
	{
		...
		if(GEngine)
		{
			GEngine->AddOnScreenDebugMessage(2, 5.f, FColor::Green, FString(TEXT("Session Created Successfully")));
		}
		UWorld* World = GetWorld();
		if(World)
		{
	...
	}else
	{
		...
		if(GEngine)
		{
			GEngine->AddOnScreenDebugMessage(2, 5.f, FColor::Red, FString(TEXT("Failed to create session")));
		}
	}
}
